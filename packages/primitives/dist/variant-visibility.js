 ...
 */
export function matchesEntryVariant(entry, selectedTags, variantActive) {
 ...
 */
export function computeVariantVisibility(cvRoot, variant) {
    const variantActive = Boolean(variant);
    const selectedTags = normalizeStringList(variant?.tags);
    const excludedSections = new Set(variantActive ? normalizeStringList(variant?.exclude_sections) : []);
...
//# sourceMappingURL=variant-visibility.js.map